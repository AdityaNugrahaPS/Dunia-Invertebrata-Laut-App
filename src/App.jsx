  ...
  const speciesData = [
    {
      ...
      author: {
        name: "Dana",
        year: 1846,
        citation: "Dana, J.D. (1846) United States Exploring Expedition during the years 1838-1842",
      },
      taxonomy: {
        Kingdom: "Animalia",
        Phylum: "Cnidaria",
    ...
    },
    {
      ...
      author: {
        name: "Dana",
        year: 1846,
        citation: "Dana, J.D. (1846) Zoophytes. United States Exploring Expedition",
      },
      taxonomy: {
        Kingdom: "Animalia",
        Phylum: "Cnidaria",
    ...
    },
    {
      ...
      author: {
        name: "Agassiz",
        year: 1836,
        citation: "Agassiz, L. (1836) Prodrome d'une monographie des radiaires ou échinodermes",
      },
      taxonomy: {
        Kingdom: "Animalia",
        Phylum: "Echinodermata",
    ...
    },
    {
      ...
      author: {
        name: "Kiener",
        year: 1843,
        citation: "Kiener, L.C. (1843) Species général et iconographie des coquilles vivantes",
      },
      taxonomy: {
        Kingdom: "Animalia",
        Phylum: "Mollusca",
    ...
    },
    {
      ...
      description: "Pitar tumens adalah spesies kerang laut dari kelas Bivalvia dan keluarga Veneridae yang ditemukan di perairan dangkal dengan substrat berpasir atau berlumpur, seperti zona pasang surut. Kerang ini memiliki cangkang oval dengan permukaan halus berwarna putih kekuningan hingga krem, sering dihiasi pola atau garis radial samar. Sebagai organisme filter feeder, Pitar tumens menyaring partikel organik dan plankton dari air, sehingga berperan penting dalam menjaga kualitas air dan ekosistem dasar laut. Selain dimanfaatkan untuk konsumsi manusia di beberapa daerah, spesies ini juga membantu stabilisasi substrat dasar laut serta menjadi bagian dari rantai makanan yang mendukung kehidupan hewan lain, seperti ikan demersal dan burung pemakan kerang. Penelitian lebih lanjut mengenai distribusi dan ekologi Pitar tumens diperlukan untuk mendukung pengelolaan sumber daya laut yang berkelanjutan.",
      habitat: "Dasar laut berpasir",
      status: "Belum Dievaluasi",
      citationDescription: "SIDAURUK, D. J. (2024). IDENTIFIKASI DAN KARAKTERISASI BIVALVIA DI KECAMATAN PANTAI CERMIN SERDANG BEDAGAI SEBAGAI PENGEMBANGAN BAHAN AJAR BERUPA BUKU MONOGRAF"
    },
    {
      name: "Spongia sp.",
      ...
      description: "Spongia sp. termasuk ke dalam filum Porifera dengan bentuk tubuh asimetris dan berlubang-lubang. Memiliki warna tubuh cokelat gelap dengan tipe kanal leucon yang kompleks. Ostium membentuk kanal-kanal incurrent yang tidak semuanya memiliki choanocytes. Aliran air dipompa secara selektif melalui kanal-kanal berflagella dan dikeluarkan melalui beberapa bukaan oskulum.",
      habitat: "Dasar laut dengan substrat keras",
      status: "Belum Dievaluasi",
      citationDescription: "Budiantoro, Agung, 2016. Petunjuk Praktikum Keanekaragaman Invertebrata dan Vertebrata. Yogyakarta. Laboratorium Fakultas MIPA Universitas Ahmad Dahlan."
    },
    {
      ...
      description: "Kerang dengan cangkang berbentuk oval hingga segitiga, berwarna putih kekuningan atau krem pucat. Memiliki permukaan halus dengan garis pertumbuhan samar. Hidup di dasar laut berpasir atau berlumpur pada kedalaman 5-50 meter. Sebagai filter feeder, memakan plankton dan partikel organik di air.",
      habitat: "Dasar laut berpasir atau berlumpur",
      status: "Belum Dievaluasi",
      citationDescription: "MolluscaBase eds. (2024). MolluscaBase. Spisula subtruncata (da Costa, 1778). Accessed through: World Register of Marine Species at: https://www.marinespecies.org/aphia.php?p=taxdetails&id=140302 on 2024-11-25"
    },
    {
      name: "Fungia sp.",
      ...
      status: "Belum Dievaluasi",
      citationDescription: "Faizsyahrani, L. P., Pertiwi, A. R., Firdhiana, W. P., & Kholifah, S. N. (2022). Inventarisasi ragam karang di Pantai Bandengan, Kabupaten Jepara, Jawa Tengah. SNSE VIII, Vol. 1(No. 1), 26–34. Universitas PGRI Semarang. ISSN: 2964-1411."
    },
    {
      ...
      status: "Belum Dievaluasi",
      citationDescription: "SeaLifeBase. (n.d.). Goniastrea retiformis (Lamarck, 1816). Retrieved November 27, 2024, from https://www.sealifebase.se"
    }
  ];
